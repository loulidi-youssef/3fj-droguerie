              ...
              <details key={order.id} className="rounded-2xl bg-white p-5 shadow-card">
                <summary className="cursor-pointer list-none">
                  <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-slate-600">{formatOrderDate(order.created_at)}</p>
                    </div>
                  </div>
                </summary>
                ...
                <div className="mt-4 border-t border-slate-200 pt-4">
                  ...
                  {order.order_items.length === 0 ? (
                    <p className="mt-2 text-sm text-slate-600">Aucun produit trouve pour cette commande.</p>
                  ) : (
                  ...
                  <form action={updateOrderStatusAction} className="mt-4 flex flex-wrap items-center gap-2">
