...
export const FloatingWhatsAppButton = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-30 inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_12px_24px_rgba(22,163,74,0.32)] transition hover:brightness-95"
    >
