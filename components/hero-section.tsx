...
export const HeroSection = () => {
  ...
  return (
    <section className="bg-[#f1f3f5] pb-3 pt-1 sm:pb-7 sm:pt-3">
      <div className="mx-auto max-w-7xl px-3 sm:px-5 lg:px-6">
        <div className="relative overflow-hidden rounded-xl shadow-[0_10px_22px_rgba(15,42,77,0.15)] sm:rounded-[28px] sm:shadow-[0_16px_34px_rgba(15,42,77,0.18)]">
          <Image
            ...
            width={1400}
            height={720}
            className="h-[206px] w-full object-cover object-center sm:h-[520px]"
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-brand-blue/90 via-brand-blue/78 to-brand-blue/35" />
          <div className="absolute inset-0 bg-gradient-to-t from-black/35 via-transparent to-transparent" />

          <div className="absolute inset-0 flex items-center px-3 py-2.5 sm:px-8 sm:py-8 lg:px-12">
            <div className="max-w-[700px]">
              ...
              <p className="mt-1 max-w-xl text-[11px] leading-4 text-slate-100 sm:mt-4 sm:text-[1.08rem] sm:leading-relaxed">
                {homepageContent.hero.subtitle}
              </p>

              <div className="mt-1.5 flex max-w-full gap-1.5 overflow-x-auto pb-0.5 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden sm:mt-4 sm:flex-wrap sm:overflow-visible sm:pb-0 sm:gap-2">
              ...
              <div className="mt-2.5 flex flex-wrap gap-1.5 sm:mt-7 sm:flex-row sm:flex-wrap sm:gap-3">
                <Link
                  href="/produits"
                ...
                <Link
                  href="/offres"
                  className="inline-flex h-8 items-center justify-center rounded-full border border-white/55 bg-white/10 px-3 text-[10px] font-bold text-white backdrop-blur transition hover:bg-white/20 sm:h-12 sm:px-6 sm:text-sm"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex h-8 items-center justify-center gap-1.5 rounded-full bg-[#1db954] px-3 text-[10px] font-bold text-white shadow-[0_8px_14px_rgba(34,197,94,0.24)] transition hover:brightness-95 sm:h-12 sm:px-5 sm:text-sm sm:shadow-[0_10px_18px_rgba(34,197,94,0.28)]"
                >
        ...
        <aside className="mt-1.5 rounded-xl border border-slate-200 bg-white p-2.5 shadow-card lg:hidden">
