...
export const TopBar = () => {
  ...
  return (
    <div className="bg-brand-orange text-white">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-x-5 gap-y-1 px-4 py-1.5 text-[11px] font-medium sm:px-5 sm:text-xs lg:px-6">
        ...
        <p className="inline-flex items-center gap-1.5 font-semibold text-orange-50">
          <svg viewBox="0 0 24 24" className="h-3.5 w-3.5" fill="currentColor" aria-hidden>
