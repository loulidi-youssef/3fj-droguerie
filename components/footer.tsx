...
export const Footer = () => {
  return (
    <footer className="bg-[#0d2d55] text-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-11 sm:px-5 md:grid-cols-4 lg:px-6">
        <div>
      ...
      <div className="border-t border-white/15 py-3 text-center text-sm text-slate-200">
