...
- For admin auth, generate `ADMIN_ACCESS_PASSWORD_HASH` with `npm run admin:hash -- "your-plain-admin-password"` then set it with `ADMIN_SESSION_SECRET` in Vercel and redeploy.
